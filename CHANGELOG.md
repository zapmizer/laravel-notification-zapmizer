...
- `Connect\InstanceClient::media(int $botInstanceId, string $messageId, ?int $timestamp = null)`. O 200 desse endpoint é binário por desenho: o guard de JSON não roda nele (redirect continua recusado); 202/404 são JSON com `media_state`.
